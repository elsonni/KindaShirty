...
exports.handler = async function (event) {
  try {
    ...
    const shippingState = (customer?.state || '').trim().toUpperCase(); // or use shipping.state if you pass it
    ...
    // Compute pieces so email equals Square totals (reuse values above)
